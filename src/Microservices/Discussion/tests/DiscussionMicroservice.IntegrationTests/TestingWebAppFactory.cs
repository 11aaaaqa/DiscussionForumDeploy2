    ...
    public class TestingWebAppFactory<TEntryPoint> : WebApplicationFactory<Program> where TEntryPoint : Program
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                appContext.Discussions.Add(new Discussion { Content = "TestContent", CreatedAt = DateOnly.FromDateTime(DateTime.UtcNow), CreatedBy = "TestCreatedBy", Id = new Guid("8077167c-d724-4258-8451-b617dc4bdfec"), Rating = 123, TopicName = "TestTopicName", Title = "TestTitle", UsersDecreasedRating = new List<string>(), UsersIncreasedRating = new List<string>()});
                appContext.Discussions.Add(new Discussion { Content = "TestContent2", CreatedAt = DateOnly.FromDateTime(DateTime.UtcNow), CreatedBy = "TestCreatedBy2", Id = new Guid("5a38b400-8be8-466c-a0ed-62249bc7811b"), Rating = -224, TopicName = "TestTopicName", Title = "TestTitle2", UsersDecreasedRating = new List<string>(), UsersIncreasedRating = new List<string>()});
                appContext.Discussions.Add(new Discussion { Content = "TestContent2", CreatedAt = DateOnly.FromDateTime(DateTime.UtcNow), CreatedBy = "TestCreatedBy2", Id = new Guid("45707155-c9c0-4c30-90b6-f3c951532368"), Rating = -2, TopicName = "TestTopicName", Title = "TestTitle3", UsersDecreasedRating = new List<string>(), UsersIncreasedRating = new List<string>() });
                appContext.Discussions.Add(new Discussion { Content = "TestContent3", CreatedAt = DateOnly.FromDateTime(DateTime.UtcNow), CreatedBy = "TestCreatedBy3", Id = Guid.NewGuid(), Rating = 1, TopicName = "TestTopicName2", Title = "TestTitle3", UsersDecreasedRating = new List<string>(), UsersIncreasedRating = new List<string>()});
